...
const fullArtistStatement = [
  ...
  <>The presented artworks never began with an image. They began with a feeling that refused to leave me. From there, I gradually constructed an environment around that emotion, constantly adjusting the space until it communicated what words could not. For my digital work, I used the 3D software <em>Blender</em> because it allowed me to control every aspect of the renderings within a single creative space, from modeling to post-processing. My traditional work followed the same process through different materials, using soft pastels, charcoal, oil, and acrylic paints.</>,
