...
const fullArtistStatement = [
  ...
  <>The presented artworks never began with an image. They began with a feeling that refused to leave me. From there, I gradually constructed an environment around that emotion, constantly adjusting the space until it communicated what words could not. For my digital work, I used <em>Blender</em> to build and refine my 3D designs, and <em>Processing</em> for creative coding and interactive pieces. My traditional work followed the same process through different materials, using soft pastels, charcoal, oil, and acrylic paints.</>,
